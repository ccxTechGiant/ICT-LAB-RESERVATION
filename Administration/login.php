...
<div class="container">
    <div class="card card-container">
        <img id="profile-img" class="profile-img-card" src="img/admin.jpg"/ style="width: 60px;height: 60px;background-color: gainsboro" >
        ...
        <form class="form-signin" data-toggle="validator" action="ajax.php" method="post" >
			<div style="margin-top: -20px;text-align: center;color: #000;font-weight: 600;text-transform: uppercase"><p>Admin</p></div>
            <div class="row">
...
<div><a href="../">Don't want to login? Cancel</a></div>
        </form><!-- /form -->
    </div><!-- /card-container -->
</div><!-- /container -->
