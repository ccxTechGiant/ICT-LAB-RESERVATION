                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="staff_type" required data-error="Select Staff Type">
                                    <option selected disabled>Select Staff Position</option>
                                    <?php
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="shift" required data-error="Select Shift Type">
                                    <option selected disabled>Select Staff Shift</option>
                                    <?php
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="P.O BOX 100 ELDORET 00100" id="address" required>
                                <div class="help-block with-errors"></div>
                            </div>
