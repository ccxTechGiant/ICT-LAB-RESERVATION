...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2023 at 03:20 PM
...
CREATE TABLE `complaint` (
  ...
  `resolve_status` varchar(500) NOT NULL,
...
(1, 'Damian Delany', 'IT Device not working', 'Kindly facilitate the activation of computers in lab CRT5', '2023-09-19 13:18:02', 'Resolved', '2023-09-19 13:18:59', 0);
...
(1, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '778878878', 'ADD 6755'),
(2, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '888888888', 'jjjjjjjjj'),
(3, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '88588586', 'jhbgfvhfh'),
(4, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '99999999', 'hhhhhhh'),
(5, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '', '990000'),
(6, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '99000000', 'hhhhhhh'),
(7, 'NICKSON ULAMI', 740492780, 'NICKSONULAMI@GMAIL.COM', 1, '89898989', 'jhbhhhh');
...
(1, 1, 3, '2023-09-19 08:27:02', NULL, '2023-09-19 08:27:02');
...
(1, 'Centre for Research and Development in IoT (CREDIT)', 2000, 500),
(2, 'Security Operation Centre (SOC)', 1500, 300),
(3, 'Forensic and Security Research Centre (FSeC)', 4000, 400),
(4, 'Cyber Threats Simulation and Response Centre (also known as a Cyber Range)', 5000, 800);
...
(1, 'Harry Noble', 2, 3, 1, '33333333', 'ADD 6755', 7565656565, 50000, '2023-09-19 08:27:02', '2023-09-19 08:27:02');
...
INSERT INTO `students` (`ID`, `First_name`, `Surname`, `Username`, `Email`, `MobileNumber`, `Password`, `validation_code`, `Status`) VALUES
(1, 'Damian', 'Delany', 'Delany', 'info.truck9harriez@gmail.com', '0723000120', 'e10adc3949ba59abbe56e057f20f883e', '720aabd323dda4829c5e9ab963f8cf2f', 0);
...
(2, 'Joy', 'Joy', 'joy@gmail.com', 'efd2c76f47b1a85c22c4584bcdd34483', '2015-11-12 12:49:22');
