                        ...
                        if (mysqli_num_rows($complaint_result) > 0) {
                            ...
                            while ($complaint = mysqli_fetch_assoc($complaint_result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($complaint['resolve_status']=='Pending'){
                                            ...
                                            echo 'Resolved on: '.date('M j, Y',strtotime($complaint['resolve_date']));
                                        }
                                        ?>
                                    </td>
                        ...
                        <div class="col-lg-12">
                            <form data-toggle="validator" role="form" method="post" action="ajax.php">
                                <div class="form-group">
                                    <label>Budget/Confirmation word</label>
                                    <input class="form-control" placeholder="eg -1000(negative budget amount) or Cancel or Resolved" name="budget" data-error="Enter Budget" required>
