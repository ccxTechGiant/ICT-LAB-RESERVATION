    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Manage Rooms & Booking
                ...
                <div class="panel-body">
                    ...
                    if (isset($_GET['success'])) {
                        echo "<div class='alert alert-success'>
                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Successfully Done !
                            </div>";
                    }
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="ajax.php?delete_room=<?php echo $rooms['room_id']; ?>"
                                           class="btn btn-danger" style="border-radius:60px;" onclick="return confirm('Are you Sure want to Delete?')"><i
                            ...
                            <form id="addRoom" data-toggle="validator" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="room_type_id" required
                                        ...
                                        <option selected disabled>Select Lab Category</option>
                                        <?php
    ...
    <div id="checkIn" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-center"><b>Room - Allocation</b></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form role="form" id="advancePayment">
                                ...
                                <div class="form-group col-lg-12">
                                    <label>Strategic plan budget.</label>
                                    <input type="number" class="form-control" id="advance_payment"
                                           placeholder="Please Enter Budget Amounts Here..">
                                </div>
                                <input type="hidden" id="getBookingID" value="">
                                <button type="submit" class="btn btn-primary pull-right">Approve & Allocate</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div id="checkOut" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-center"><b>Room- Approval</b></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form role="form" id="checkOutRoom_n" data-toggle="validator">
                                ...
                                <div class="form-group col-lg-12">
                                    <label><b>Remaining Budget</b></label>
                                    <input type="text" class="form-control" id="remaining_amount"
                                           placeholder="Remaining Budget" required
                                           data-error="Please Enter Remaining  Budget Amount">
                                    <div class="help-block with-errors"></div>
                                </div>
