...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" href="index.php?room_mang">Plan Booking</a>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h4 style="font-weight: bold">Planned Budget: <span id="price"><?php echo $get_room_price; ?></span> /-</h4>
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-secondary pull-right" style="border-radius:0%" href="index.php?reservation">Plan Booking</a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    <label>Lab Type</label>
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold">Panned Budget: <span id="price">0</span> /-</h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price">0</span> /-</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" placeholder="First Name" id="first_name" data-error="Enter First Name" required value="<?php echo $students['First_name'];?>">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Last Name</label>
                                <input class="form-control" placeholder="Last Name" id="last_name" value="<?php echo $students['Surname'];?>">
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Contact Number</label>
                                <input type="number" class="form-control" data-error="Enter Min 10 Digit" data-minlength="10" placeholder="Contact No" id="contact_no" required value="<?php echo $students['MobileNumber'];?>">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Email Address</label>
                                <input type="email" class="form-control" placeholder="Email Address" id="email" data-error="Enter Valid Email Address" required value="<?php echo $students['Email'];?>">
                                <div class="help-block with-errors"></div>
                            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Designed by: Joy</p>
        </div>
    </div>
