...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"10001480");
        ...
        document.getElementById('id_card_no').setAttribute('data-minlength','8');
        document.getElementById('id_card_no').setAttribute('placeholder',"COA/26351");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 8 Character(include '/') Valid Allien ID No");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','7');
        document.getElementById('id_card_no').setAttribute('placeholder',"RKS178A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 7 Character Valid Student ID No");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','6');
        document.getElementById('id_card_no').setAttribute('placeholder',"RJ 2869");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 6 Character(include space) Smart Card Number");
    }
}
...
$('#booking').submit(function () {
    ...
    if(!room_no && !first_name && !contact_no && !id_card_no && !address){
        $('.response').html('<div class="alert bg-danger alert-dismissable" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>Please Fill All fields</div>');
    }else{
        $.ajax({
            type: 'post',
            url: 'ajax.php',
