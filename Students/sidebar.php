...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <div class="profile-sidebar">
        ...
        <div class="profile-usertitle">
            <div class="profile-usertitle-name"><?php echo $students['Surname'];?></div>
            <div class="profile-usertitle-status"><span class="indicator label-success"></span>IT Student</div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <?php 
       ...
       <?php }
        ...
        <?php } else{?>
            <li>
            <a href="index.php?room_mang"><em class="fa fa-star">&nbsp;</em>
                    Manage Booking
                </a>
            </li>
       <?php }
