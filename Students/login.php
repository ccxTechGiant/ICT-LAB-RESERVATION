...
<div class="container">
    <div class="card card-container">
        <img id="profile-img" class="profile-img-card" src="img/gap.jpg"/ style="height: 60px;width: 60px">
        ...
        <form class="form-signin" data-toggle="validator" action="ajax.php" method="post">
			<div style="margin-top: -20px;text-align: center;color: #000;font-weight: 600;text-transform: uppercase"><p>Student</p></div>
            <div class="row">
          ...
          <div><a href="../" class="link">Cancel</a></div>
            <button class="btn btn-lg btn-success btn-block btn-signin" type="submit" name="login">LOGIN</button>
			<div><a href="../account/" class="link">Don't have account? Create</a></div>
        </form><!-- /form -->
    </div><!-- /card-container -->
</div><!-- /container -->
